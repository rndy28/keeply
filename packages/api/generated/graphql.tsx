...
export type NoteInputFragment = { __typename?: 'Note', id: string, title?: string | null, text?: string | null, archived?: boolean | null, pinned?: boolean | null, indexColor?: number | null, time?: string | null, trashed?: boolean | null, createdAt: any, updatedAt: any, labels?: Array<{ __typename?: 'Label', id: string, name: string }> | null };

export type RegularUserFragment = { __typename?: 'User', id: string, name: string, email: string, picture?: string | null };

export type RegularUserResponseFragment = { __typename?: 'UserResponse', error?: { __typename?: 'Error', field: string, message: string } | null, user?: { __typename?: 'User', id: string, name: string, email: string, picture?: string | null } | null };
...
export type ChangePasswordMutation = { __typename?: 'Mutation', changePassword: { __typename?: 'UserResponse', error?: { __typename?: 'Error', field: string, message: string } | null, user?: { __typename?: 'User', id: string, name: string, email: string, picture?: string | null } | null } };
...
export type CreateNoteMutation = { __typename?: 'Mutation', createNote: { __typename?: 'Note', id: string, title?: string | null, text?: string | null, archived?: boolean | null, pinned?: boolean | null, indexColor?: number | null, time?: string | null, trashed?: boolean | null, createdAt: any, updatedAt: any, labels?: Array<{ __typename?: 'Label', id: string, name: string }> | null } };
...
export type EditLabelMutation = { __typename?: 'Mutation', editLabel: { __typename?: 'Label', id: string, name: string } };
...
export type RestoreNoteFromTrashMutation = { __typename?: 'Mutation', restoreNoteFromTrash: boolean };
...
export type SigninMutation = { __typename?: 'Mutation', signin: { __typename?: 'UserResponse', error?: { __typename?: 'Error', field: string, message: string } | null, user?: { __typename?: 'User', id: string, name: string, email: string, picture?: string | null } | null } };
...
export type SigninFromGoogleMutation = { __typename?: 'Mutation', signinFromGoogle: { __typename?: 'UserResponse', error?: { __typename?: 'Error', field: string, message: string } | null, user?: { __typename?: 'User', id: string, name: string, email: string, picture?: string | null } | null } };
...
export type SignupMutation = { __typename?: 'Mutation', signup: { __typename?: 'UserResponse', error?: { __typename?: 'Error', field: string, message: string } | null, user?: { __typename?: 'User', id: string, name: string, email: string, picture?: string | null } | null } };
...
export type MeQuery = { __typename?: 'Query', me?: { __typename?: 'User', id: string, name: string, email: string, picture?: string | null } | null };

export type NotesQueryVariables = Exact<{ [key: string]: never; }>;


export type NotesQuery = { __typename?: 'Query', notes: Array<{ __typename?: 'Note', id: string, title?: string | null, text?: string | null, archived?: boolean | null, pinned?: boolean | null, indexColor?: number | null, time?: string | null, trashed?: boolean | null, createdAt: any, updatedAt: any, labels?: Array<{ __typename?: 'Label', id: string, name: string }> | null }> };

export type ReminderSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type ReminderSubscription = { __typename?: 'Subscription', reminder: { __typename?: 'NotificationPayload', title: string, body: string } };
...
export function useRestoreNoteFromTrashMutation() {
  return Urql.useMutation<RestoreNoteFromTrashMutation, RestoreNoteFromTrashMutationVariables>(RestoreNoteFromTrashDocument);
};
...
export function useLabelsQuery(options?: Omit<Urql.UseQueryArgs<LabelsQueryVariables>, 'query'>) {
  return Urql.useQuery<LabelsQuery, LabelsQueryVariables>({ query: LabelsDocument, ...options });
};
...
export function useReminderSubscription<TData = ReminderSubscription>(options: Omit<Urql.UseSubscriptionArgs<ReminderSubscriptionVariables>, 'query'> = {}, handler?: Urql.SubscriptionHandler<ReminderSubscription, TData>) {
  return Urql.useSubscription<ReminderSubscription, TData, ReminderSubscriptionVariables>({ query: ReminderDocument, ...options }, handler);
};