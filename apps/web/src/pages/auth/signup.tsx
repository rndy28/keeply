    ...
    <Container>
      ...
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Group>
          ...
          />
          {errors.name?.type === "required" && <InputError id="name-error">name is required</InputError>}
        </Group>
        ...
        <Group>
          ...
          <Input
            ...
            variant="neutral"
            type={passwordType}
            aria-invalid={errors.password?.type === "required" ? true : errors.password?.type === "minLength"}
